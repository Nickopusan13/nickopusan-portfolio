...
import { SiFastapi, SiGithub, SiSupabase } from "react-icons/si";
...
const GSAPIcon = () => (
  <svg
    ...
    viewBox="0 0 82 30"
    className="w-25 h-25 lg:w-36 lg:h-36 text-zinc-900 transition-transform duration-300
               hover:scale-110 hover:drop-shadow-[0_0_10px_#facc15]"
    fill="currentColor"
  >
...
const LenisIcon = () => (
  <div className="text-8xl lg:text-9xl inline-block transition-transform duration-300 hover:scale-110 hover:drop-shadow-[0_0_10px_#22d3ee]">
    <Image
      src="/assets/logo/lenis-logo.webp"
      alt="Lenis Logo"
      width={100}
      height={100}
