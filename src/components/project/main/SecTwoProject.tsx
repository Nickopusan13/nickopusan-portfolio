...
export default function SecTwoProject() {
  ...
  return (
    <section
      ...
      "
    >
      <div className="relative z-10 px-5 py-10 lg:px-10 lg:py-16">
        <div
          className="
        ...
        >
          <motion.div
            ...
            className="
              ...
              border-4 border-black bg-amber-300
              px-6 py-8 font-bold
          ...
          >
            <div className="flex w-full items-center justify-between text-black">
              <span
                className="
                  rounded-tr-xl rounded-bl-xl border-2 border-black
                  bg-orange-500 px-3 py-1
                  text-sm font-black
            ...
            <h2
              className="
                ...
                drop-shadow-[3px_3px_0px_rgba(255,255,255,0.65)]
                lg:text-5xl
              "
            >
          ...
          <motion.div
            ...
            className="
              hidden min-h-64 rounded-tl-4xl rounded-br-4xl
              border-4 border-black bg-amber-200
              shadow-[8px_8px_0px_#000]
              lg:block
            "
          >
        ...
        <div
          ref={scrollSection}
          className="relative mt-10 flex flex-col gap-10 md:block md:h-[78svh]"
        >
          {item.map((item, idx) => {
            const number = idx + 1;
            return (
              ...
              "
                ...
                <div className="flex flex-col gap-8">
                  <div className="flex flex-col gap-4">
                    <h3
                      className="
                  w-fit rounded-tr-xl rounded-bl-xl
                  border-2 border-black bg-amber-200
                  px-3 py-1 text-lg font-black
                  shadow-[3px_3px_0px_#000]
                "
                    >
                      {item.title1}
                    </h3>
                    <h3 className="text-3xl font-black leading-tight lg:text-5xl">
                      {item.title2}
                    </h3>
                  </div>
                  <p className="max-w-3xl text-base font-bold leading-relaxed text-black/75 lg:text-lg">
                    {item.description}
                  </p>
                  <motion.button
                    whileHover={{
                ...
                border-2 border-black bg-amber-200
                px-5 py-3 text-lg font-black text-black
              "
                  >
              ...
              border-4 border-black bg-amber-100
            "
                >
                  <div
