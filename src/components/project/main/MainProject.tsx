  ...
  return (
    <div className="min-h-svh py-20 text-white overflow-hidden bg-amber-600">
      <section className="flex flex-col items-center justify-center gap-4 lg:gap-8 px-5 lg:px-20">
        ...
        <h1 className="text-center text-5xl md:text-6xl font-black leading-none text-amber-200 drop-shadow-[5px_5px_0px_#000] lg:text-8xl xl:text-9xl">
          Our Craft
        </h1>
                ...
                <DropdownMenu>
                  <DropdownMenuTrigger asChild>
                    <motion.button
                      ...
                      className="cursor-pointer rounded-tr-xl rounded-bl-xl border-2 border-black bg-amber-300 px-3 lg:px-10 md:px-5 py-2 lg:py-3 text-base md:text-lg font-black text-black shadow-[5px_5px_0px_#000]"
                    >
                      FILTER
                    </motion.button>
                  </DropdownMenuTrigger>
              ...
              <AnimatePresence mode="wait">
                {activeGrid !== "grid4" && (
                  <motion.div
                    ...
                    className="hidden md:flex md:gap-2 lg:gap-3 justify-center items-center"
                  >
                    {images.map((img, idx) => (
                      <motion.div
                        whileHover={{
                        ...
                        className="relative w-22 h-12 lg:h-12 lg:w-24 cursor-pointer rounded-md border-2 border-black bg-amber-200 p-1 shadow-[4px_4px_0px_#000]"
                        key={idx}
                    ...
                    <Tooltip key={item.id}>
                      <TooltipTrigger asChild>
                        <motion.button
                          ...
                          className="relative cursor-pointer rounded-lg border-2 border-black bg-amber-300 p-2 text-xl lg:text-2xl text-black overflow-hidden"
                        >
                          {activeGrid === item.id && (
                            <motion.div
                ...
                <AnimatePresence>
                  {activeGrid !== "grid4" && (
                    <motion.div
                      ...
                      className="flex gap-2 text-black text-base lg:text-xl"
                    >
